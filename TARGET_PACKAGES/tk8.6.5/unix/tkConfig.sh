...
# installed.
TK_PREFIX='/opt/ARM/buildroot/output/host/usr/arm-buildroot-linux-gnueabihf/sysroot/usr/lib'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/opt/ARM/buildroot/output/host/usr/arm-buildroot-linux-gnueabihf/sysroot/usr/lib'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/opt/ARM/buildroot/TARGET_PACKAGES/tk8.6.5/unix -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/opt/ARM/buildroot/output/host/usr/arm-buildroot-linux-gnueabihf/sysroot/usr/lib/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/opt/ARM/buildroot/output/host/usr/arm-buildroot-linux-gnueabihf/sysroot/usr/lib/include'
...
# compiled.
TK_SRC_DIR='/opt/ARM/buildroot/TARGET_PACKAGES/tk8.6.5'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/opt/ARM/buildroot/TARGET_PACKAGES/tk8.6.5/unix -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/opt/ARM/buildroot/output/host/usr/arm-buildroot-linux-gnueabihf/sysroot/usr/lib/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/opt/ARM/buildroot/TARGET_PACKAGES/tk8.6.5/unix/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/opt/ARM/buildroot/output/host/usr/arm-buildroot-linux-gnueabihf/sysroot/usr/lib/lib/libtkstub8.6.a'
